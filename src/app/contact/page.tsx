  ...
  return (
    <>
      <section
        id="contact"
        ref={sectionRef}
        className="w-full bg-neutral-950 text-neutral-200 px-6 md:px-12 lg:px-28 py-20 relative"
      >
        <div className="max-w-6xl grid lg:grid-cols-2 gap-20 items-start">
          {/* LEFT — POSITIONING */}
          <div>
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-semibold text-white leading-tight mb-8">
