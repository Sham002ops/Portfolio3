...
// import CButton from '../../homeComponents/CTASection';
...
//   // UPDATED: Set initial states - hide ENTIRE card
...
//       <div className="tagline-container absolute top-[40%] left-[7.5rem] -translate-y-1/2 w-[55%] z-10">
...
//          Reduced operational overhead by 15+ hours/month for clients
//         </h2>
//       </div>
// {/* 
...
//           <p className="case-study-stat">Built scalable automation workflows</p>
//           <p className="case-study-stat">Integrated multi-tier tracking system</p>
//         </div>
