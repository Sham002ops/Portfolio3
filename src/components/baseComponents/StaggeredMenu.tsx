...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden -mt-2' : 'w-full h-full'}`}
    >
      <div
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex  mt-2 items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto ${
